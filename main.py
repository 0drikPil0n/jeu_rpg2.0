...
def commencer_quete(p_perso:Personnage=None):
    """
...
if __name__ == '__main__':
    ...
    while True:
        while True:
            try:
                sauvegarde =  int(input("Souhaitez-vous commencer une nouvelle partie ou en reprendre une ancienne?\n"
        ...
        match sauvegarde:
            ...
            case 2:
                with open("personnage.json", "r", encoding="utf-8") as perso_json:
                ...
                if not liste_personnage:
                    ...
                    try:
                        ...
                        personnage_choisi = liste_personnage[numero]
